...
import com.hashtagco.bussinesserver.Model.SuccessfulRequest;
import com.hashtagco.bussinesserver.ViewHolder.SuccessfulDeliveryViewHolder;
     ...
     fabRemoveAllItems.setOnClickListener(new View.OnClickListener() {
         ...
         public void onClick(View view)
         {
             ...
             final AlertDialog.Builder alertBuilder=new AlertDialog.Builder
                     (SuccessfulDeliveryRequest.this);
...
*/
   ...
   /* private void iniView()
    ...
    private void loadAllOrdersSendToClint()
    {
        ...
        adapter=new FirebaseRecyclerAdapter<SuccessfulRequest, SuccessfulDeliveryViewHolder>
                (allSuccessfulRequest) {
            @Override
            protected void onBindViewHolder(@NonNull SuccessfulDeliveryViewHolder holder,
                                            final int position, @NonNull SuccessfulRequest model)
            {
