package com.hashtagco.bussinesserver.Helper;
...
//Notification only Working this Function if API 26 OR Higher
public class NotificationHelper extends ContextWrapper {


    private static final String EMB_CHANNEL_ID="com.example.eng_mahnoud83coffey.embeatitserver." +
            "Helper.Food.Spotting";
